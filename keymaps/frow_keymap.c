...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [QWERTY] = LAYOUT(
        KC_F12,   KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,          KC_CAPS,  KC_PSCR,  KC_SCRL,  KC_PAUS, QK_BOOT, TG(1),    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11, 
...
LCTL_T(KC_ESC),   KC_A,     KC_S,     KC_D,     KC_F,     KC_G,                                                                      KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,
  ...
  [NUMPAD] = LAYOUT(
            KC_F12,   KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,          KC_CAPS,  KC_PSCR,  KC_SCRL,  KC_PAUS, QK_BOOT, KC_TRNS,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,    KC_F11, 
